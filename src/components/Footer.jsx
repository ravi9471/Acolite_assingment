  ...
  return (
    <footer className="footer">
      ...
      <div className="social-links">
        <img className='img_media' src="facebook.png" alt="facebook"></img>
        <img className='img_media' src="twitter.png" alt="twitter"></img>
        <img className='img_media' src="Linkdin.png" alt="linkdin"></img>
        <img className='img_media' src="Gmail.jpg" alt="gmail"></img>
      </div>
      <div>
